export function JsonLd() {
  ...
  const personSchema = {
    ...
    description: "Senior Full Stack Software Engineer based in Kathmandu, Nepal with 7+ years of proven expertise delivering high-performance, scalable web applications. CSIT graduate from Tribhuvan University. Specializes in React, Node.js, TypeScript, and enterprise-grade solutions.",
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Saurav Sitaula is a Senior Full Stack Software Engineer based in Kathmandu, Nepal with over 7 years of professional experience. He holds a CSIT degree from Tribhuvan University (TU) and specializes in React, Node.js, TypeScript, and Next.js. He currently leads development initiatives at UBA Solutions, a Monotype Partner Company.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Saurav Sitaula has deep expertise in JavaScript, TypeScript, React, Next.js, Node.js, PostgreSQL, MongoDB, GraphQL, and Redux. He specializes in architecting scalable full-stack web applications, RESTful API development, and headless e-commerce platforms including Shopify.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Saurav Sitaula has over 7 years of professional experience in software engineering. His career spans roles from developer to senior engineer and development lead, with expertise in building production-grade applications for diverse industries including e-commerce, education, and logistics.",
        },
      },
    ],
  };
