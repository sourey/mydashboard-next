...
const stacks = {
  ...
  Tools: {
    icon: "🛠️",
    color: "bg-neo-primary",
    items: ["Git", "Docker", "AWS", "Vercel", "GitHub Actions", "Jenkins"],
  },
};
...
export default function TechStack() {
  ...
  return (
    <section id="stack" className="py-20 relative" ref={sectionRef}>
      {/* Zigzag top border */}
      <div
        className="absolute top-0 left-0 right-0 h-4 bg-neo-secondary"
        style={{
          clipPath:
                  ...
                  {[
                    ...
                    <span
                      ...
                      className={`text-lg font-black uppercase ${
                        idx % 2 === 0 ? "text-neo-accent" : "text-white"
                      }`}
                    >
                      {text}
                    </span>
      ...
      <div
        className="absolute bottom-0 left-0 right-0 h-4 bg-neo-secondary"
        style={{
          clipPath:
